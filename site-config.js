window.siteConfig = {
  ...
  media: {
    ...
    memoryGallery: [
      ...
      {
        src: "assets/images/memory-two.svg",
        alt: "Memory placeholder two",
        caption: "A favorite memory"
      },
      {
        src: "assets/images/memory-three.svg",
